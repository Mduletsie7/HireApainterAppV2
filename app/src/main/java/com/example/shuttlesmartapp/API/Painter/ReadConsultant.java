...
public class ReadConsultant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_read_consultant);

        // initializing our views
        txtConsultantID = (EditText) findViewById(R.id.consultantID);
        btnReadConsultant = findViewById(R.id.btnReadConsultant);
        ...
        btnReadConsultant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (txtConsultantID.getText().toString().isEmpty()) {
                    Toast.makeText(ReadConsultant.this, "Please fill in all the fields", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void readDataUsingVolley(String consultantId) {
        ...
        String url = "http://192.168.0.107:8080/consultant/read/" + consultantId;
        loadingPB.setVisibility(View.VISIBLE);

        // creating a new variable for our request queue
        RequestQueue queue = Volley.newRequestQueue(ReadConsultant.this);
