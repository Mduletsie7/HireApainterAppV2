...
public class ReadQuote extends AppCompatActivity {
        ...
        btnReadQuote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (txtQuoteID.getText().toString().isEmpty()) {
                    Toast.makeText(ReadQuote.this, "Please fill in all the fields", Toast.LENGTH_SHORT).show();
                    return;
                }
                Log.d("TestGettext", txtQuoteID.getText().toString());
                // calling a method to post the data and passing our text fields.
                String painterId = txtQuoteID.getText().toString();
    ...
    private void readDataUsingVolley(String quoteId) {
        // url to post our data
        String url = "http://192.168.8.100:8080/painter/read/" + quoteId;
        loadingPB.setVisibility(View.VISIBLE);

        // creating a new variable for our request queue
        RequestQueue queue = Volley.newRequestQueue(ReadQuote.this);
