...
public class ReadCustomer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReadCustomer = findViewById(R.id.btnReadCustomer);
        ...
        btnReadCustomer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (txtCustomerId.getText().toString().isEmpty()) {
                    Toast.makeText(ReadCustomer.this, "Please fill in all the fields", Toast.LENGTH_SHORT).show();
                    return;
                }
                Log.d("TestGettext", txtCustomerId.getText().toString());
                // calling a method to post the data and passing our text fields.
                String painterId = txtCustomerId.getText().toString();
    ...
    private void readDataUsingVolley(String customerId) {
        ...
        String url = "http://192.168.8.100:8080/customer/read/" + customerId;
        loadingPB.setVisibility(View.VISIBLE);

        // creating a new variable for our request queue
        RequestQueue queue = Volley.newRequestQueue(ReadCustomer.this);
