...
public class DeletePainter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_painter);

        // initializing our views
        txtPainterID = (EditText) findViewById(R.id.painterID);
        btnReadPainter = findViewById(R.id.btnDeletePainter);
        ...
        btnReadPainter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (txtPainterID.getText().toString().isEmpty()) {
                    Toast.makeText(DeletePainter.this, "Please fill in all the fields", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void readDataUsingVolley(String painterId) {
        ...
        RequestQueue queue = Volley.newRequestQueue(DeletePainter.this);
